...
#ifndef BITELONCOIN_WALLET_ISMINE_H
#define BITELONCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/biteloncoin/biteloncoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // BITELONCOIN_WALLET_ISMINE_H
