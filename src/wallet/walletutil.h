...
#ifndef BITELONCOIN_WALLET_WALLETUTIL_H
#define BITELONCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! biteloncoin from opening the wallet, thinking it was newly created, and
...
#endif // BITELONCOIN_WALLET_WALLETUTIL_H
