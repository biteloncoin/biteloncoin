...
#ifndef BITELONCOIN_WALLET_EXTERNAL_SIGNER_H
#define BITELONCOIN_WALLET_EXTERNAL_SIGNER_H
...
public:
    ...
    //! BitElonCoin mainnet, testnet, etc
    std::string m_chain;
...
#endif // BITELONCOIN_WALLET_EXTERNAL_SIGNER_H
