...
#ifndef BITELONCOIN_WALLET_WALLET_H
#define BITELONCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this biteloncoin node, and set to 0 for transactions that were created
...
#endif // BITELONCOIN_WALLET_WALLET_H
