...
#ifndef BITELONCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BITELONCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitElonCoin Core wallet was originally a collection of unrelated private
...
#endif // BITELONCOIN_WALLET_SCRIPTPUBKEYMAN_H
