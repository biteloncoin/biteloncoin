...
#ifndef BITELONCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BITELONCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@biteloncoin.
 *
 ...
 *
 * The chacha20-poly1305@biteloncoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@biteloncoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@biteloncoin are relatively fast in
...
#endif // BITELONCOIN_CRYPTO_CHACHA_POLY_AEAD_H
