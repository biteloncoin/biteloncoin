...
#ifndef BITELONCOIN_UTIL_MESSAGE_H
#define BITELONCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's biteloncoin address, it must refer to a public key.
...
#endif // BITELONCOIN_UTIL_MESSAGE_H
