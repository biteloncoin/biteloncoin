...
#ifndef BITELONCOIN_UTIL_SETTINGS_H
#define BITELONCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/biteloncoin/biteloncoin/pull/15934/files#r337691812)
...
#endif // BITELONCOIN_UTIL_SETTINGS_H
