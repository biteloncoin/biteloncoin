...
#ifndef BITELONCOIN_COMPAT_ASSUMPTIONS_H
#define BITELONCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitElonCoin cannot be compiled without assertions."
#endif
...
#endif // BITELONCOIN_COMPAT_ASSUMPTIONS_H
