...
#ifndef BITELONCOIN_INTERFACES_NODE_H
#define BITELONCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a biteloncoin node (biteloncoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITELONCOIN_INTERFACES_NODE_H
