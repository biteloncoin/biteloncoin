...
#ifndef BITELONCOIN_SCRIPT_STANDARD_H
#define BITELONCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a biteloncoin address
 */
...
/**
 * Generate a BitElonCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITELONCOIN_SCRIPT_STANDARD_H
