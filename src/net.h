...
#ifndef BITELONCOIN_NET_H
#define BITELONCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/biteloncoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitElonCoin’s Peer-to-Peer Network")
