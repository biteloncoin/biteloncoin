// Copyright (c) 2009-2021 The BitElonCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITELONCOIN_TEST_FUZZ_UTIL_H
#define BITELONCOIN_TEST_FUZZ_UTIL_H
...
#endif // BITELONCOIN_TEST_FUZZ_UTIL_H
