...
{
    BOOST_CHECK(TestSplitHost("www.biteloncoincore.org", "www.biteloncoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.biteloncoincore.org]", "www.biteloncoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.biteloncoincore.org:80", "www.biteloncoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.biteloncoincore.org]:80", "www.biteloncoincore.org", 80));
