...
#ifndef BITELONCOIN_TEST_SCRIPTNUM10_H
#define BITELONCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitElonCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITELONCOIN_TEST_BIGNUM_H
