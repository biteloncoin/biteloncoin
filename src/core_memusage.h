// Copyright (c) 2015-2018 The BitElonCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITELONCOIN_CORE_MEMUSAGE_H
#define BITELONCOIN_CORE_MEMUSAGE_H
...
#endif // BITELONCOIN_CORE_MEMUSAGE_H
