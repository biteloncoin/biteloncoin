...
#ifndef BITELONCOIN_QT_GUIUTIL_H
#define BITELONCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the BitElonCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "biteloncoin:" URI into recipient object, return true on successful parsing
...
#endif // BITELONCOIN_QT_GUIUTIL_H
