...
#ifndef BITELONCOIN_QT_BITELONCOINGUI_H
#define BITELONCOIN_QT_BITELONCOINGUI_H
...
/**
  BitElonCoin GUI main class. This class represents the main window of the BitElonCoin UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a biteloncoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BitElonCoin Transaction from file or clipboard */
...
#endif // BITELONCOIN_QT_BITELONCOINGUI_H
