...
#ifndef BITELONCOIN_QT_WALLETMODEL_H
#define BITELONCOIN_QT_WALLETMODEL_H
...
/** Interface to BitElonCoin wallet from Qt view code. */
...
#endif // BITELONCOIN_QT_WALLETMODEL_H
