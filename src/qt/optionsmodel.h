...
#ifndef BITELONCOIN_QT_OPTIONSMODEL_H
#define BITELONCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BitElonCoin client.
...
#endif // BITELONCOIN_QT_OPTIONSMODEL_H
