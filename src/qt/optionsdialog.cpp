    ...
    mapper(nullptr)
{
    ...
    ui->biteloncoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->biteloncoinAtStartup);
    ...
    ui->biteloncoinAtStartup->setToolTip(ui->biteloncoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->biteloncoinAtStartup->setText(ui->biteloncoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->biteloncoinAtStartup, OptionsModel::StartAtStartup);
