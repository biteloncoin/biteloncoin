# Bootstrappable BitElonCoin Core Builds

This directory contains the files necessary to perform bootstrappable BitElonCoin
Core builds.
...
From the top of a clean BitElonCoin Core repository:
...
To use dongcarl's substitute server for BitElonCoin Core builds after having
