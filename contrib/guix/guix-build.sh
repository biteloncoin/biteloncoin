...
# Deterministically build BitElonCoin Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/biteloncoin'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/biteloncoin/' to
        #     '/home/satoshi/biteloncoin/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/biteloncoin
        #
        #                     maps our current working directory to /biteloncoin
        ...
        #     container so that we have something to build. '/biteloncoin' was
        #     chosen arbitrarily.
        #
        ...
        #
        #     When builds of the Guix environment itself (not BitElonCoin Core)
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /biteloncoin && bash contrib/guix/libexec/build.sh"
    )
