...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the biteloncoin repository."
  exit 1
fi
...
# See https://github.com/biteloncoin/biteloncoin/issues/16064
...
echo 'When compiling biteloncoind, run `./configure` in the following way:'
echo
