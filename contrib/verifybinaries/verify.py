...
biteloncoincore.org and biteloncoin.org and compares them.
...
WORKINGDIR = "/tmp/biteloncoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://biteloncoincore.org"
HOST2 = "https://biteloncoin.org"
VERSIONPREFIX = "biteloncoin-core-"
...
def main(args):
    ...
    if not success:
        print("biteloncoin.org failed to provide signature file, "
              "but biteloncoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("biteloncoin.org and biteloncoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the BitElonCoin Core binary release "
