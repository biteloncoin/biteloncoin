...
The BitElonCoin Core daemon can be configured to act as a trusted "border
router", implementing the biteloncoin wire protocol and relay, making
...
The ZeroMQ feature in BitElonCoin Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building biteloncoind:
...
For instance:
    ...
    $ biteloncoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/biteloncoind.tx.raw \
...
These options can also be provided in biteloncoin.conf.
...
From the perspective of biteloncoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into biteloncoind directly. Furthermore, no information is
