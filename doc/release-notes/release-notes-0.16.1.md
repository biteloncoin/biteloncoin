BitElonCoin Core version 0.16.1 is now available from:

  <https://biteloncoincore.org/bin/biteloncoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting biteloncoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure biteloncoind processes are cleaned up when tests end (sdaftuar)
