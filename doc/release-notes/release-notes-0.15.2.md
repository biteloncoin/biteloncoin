BitElonCoin Core version *0.15.2* is now available from:

  <https://biteloncoincore.org/bin/biteloncoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in biteloncoin-tx (TheBlueMatt)
