BitElonCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/biteloncoin/files/BitElonCoin/biteloncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitElonCoin
...
New/changed settings (command-line or biteloncoin.conf file)
--------------------------------------------------------
