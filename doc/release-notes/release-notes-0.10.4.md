BitElonCoin Core version 0.10.4 is now available from:

  <https://biteloncoin.org/bin/biteloncoin-core-0.10.4/>
...
- #6953 `43c2789` Split biteloncoin-tx into its own package
- #6953 `dfe0d4d` Include biteloncoin-tx binary on Debian/Ubuntu
