BitElonCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/biteloncoin/files/BitElonCoin/biteloncoin-0.5.4/
...
http://gitorious.org/biteloncoin/biteloncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitElonCoin-Qt notifications under Growl 1.3.
Increase required age of BitElonCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing BitElonCoin-Qt over it. (Windows)
