BitElonCoin Core version 0.16.3 is now available from:

  <https://biteloncoincore.org/bin/biteloncoin-core-0.16.3/>
...
been discovered in BitElonCoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` biteloncoinconsensus: invalid flags error should be set to `biteloncoinconsensus_err` (afk11)
