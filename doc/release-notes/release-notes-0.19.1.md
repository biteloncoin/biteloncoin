...
BitElonCoin Core version 0.19.1 is now available from:

  <https://biteloncoincore.org/bin/biteloncoin-core-0.19.1/>
...
From BitElonCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BitElonCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BitElonCoin Core does not yet change appearance when
...
- #17488 fix "biteloncoind already running" warnings on macOS (fanquake)
