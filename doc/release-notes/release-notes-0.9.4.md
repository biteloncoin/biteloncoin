BitElonCoin Core version 0.9.4 is now available from:

  https://biteloncoin.org/bin/0.9.4/
...
this update is incompatible with the BitElonCoin system and could lead to consensus
forks.

BitElonCoin Core released binaries from https://biteloncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~biteloncoin/+archive/ubuntu/biteloncoin
- A third-party or self-compiled BitElonCoin Core

upgrade to BitElonCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
