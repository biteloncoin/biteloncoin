BitElonCoin Core version 0.14.1 is now available from:

  <https://biteloncoin.org/bin/biteloncoin-core-0.14.1/>
...
here:
[reducing-biteloncoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` biteloncoin-tx input verification (awemany, jnewbery)
