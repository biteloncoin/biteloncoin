BitElonCoin Core version 0.14.2 is now available from:

  <https://biteloncoin.org/bin/biteloncoin-core-0.14.2/>
...
(in BitElonCoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate biteloncoin-config.h as necessary (theuni)
