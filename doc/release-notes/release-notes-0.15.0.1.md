BitElonCoin Core version *0.15.0.1* is now available from:

  <https://biteloncoin.org/bin/biteloncoin-core-0.15.0.1/>

and

  <https://biteloncoincore.org/bin/biteloncoin-core-0.15.0.1/>
