BitElonCoin Core version 0.13.2 is now available from:

  <https://biteloncoin.org/bin/biteloncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update biteloncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow biteloncoin-tx to create v2 transactions (btcdrak)
