...
This document provides guidelines for internationalization of the BitElonCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `biteloncoin_en.ts` remains unchanged.
