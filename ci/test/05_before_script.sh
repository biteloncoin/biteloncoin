...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BitElonCoin
else
  DOCKER_EXEC echo \> \$HOME/.biteloncoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/biteloncoin/biteloncoin/pull/18288#discussion_r433189350 for
  # details.
