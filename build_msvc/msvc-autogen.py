#!/usr/bin/env python3
# Copyright (c) 2016-2019 The BitElonCoin Core developers
...
libs = [
    'libbiteloncoin_cli',
    'libbiteloncoin_common',
    'libbiteloncoin_crypto',
    'libbiteloncoin_server',
    'libbiteloncoin_util',
    'libbiteloncoin_wallet_tool',
    'libbiteloncoin_wallet',
    'libbiteloncoin_zmq',
    'bench_biteloncoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='BitElonCoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/biteloncoin_config.h'), os.path.join(SOURCE_DIR, 'config/biteloncoin-config.h'))
