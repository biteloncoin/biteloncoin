...
// biteloncoin includes.
#include <..\src\script\biteloncoinconsensus.h>
...
int main()
{
    std::cout << "biteloncoinconsensus version: " << biteloncoinconsensus_version() << std::endl;
    ...
    auto op0Result = biteloncoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, biteloncoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
