...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `biteloncoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and biteloncoin-cli getwalletinfo return expected wallet info")
            ...
            # Test biteloncoin-cli -generate with -rpcwallet in multiwallet mode.
