...
"""Verify that starting biteloncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start biteloncoin with -h for help text")
        ...
        self.log.info("Start biteloncoin with -version for version information")
        ...
        self.log.info("Start biteloncoind with -fakearg to make sure it does not start")
