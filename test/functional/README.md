...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The CI linter job also checks this, but [possibly not in all cases](https://github.com/biteloncoin/biteloncoin/pull/14884#discussion_r239585126).
...
with the biteloncoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a biteloncoind.  `P2PInterface`
contains the higher level logic for processing P2P payloads and connecting to
the BitElonCoin Core node application logic. For custom behaviour, subclass the
...
Taken from the [python-biteloncoinrpc repository](https://github.com/jgarzik/python-biteloncoinrpc).
...
Test objects for interacting with a biteloncoind node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-biteloncoinlib)
