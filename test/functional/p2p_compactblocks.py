...
# TestP2PConn: A peer we use to send messages to biteloncoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes biteloncoind to (reasonably!) disconnect us, so do this last.
    ...
    # biteloncoind's choice of nonce.
    ...
    # Test that biteloncoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for biteloncoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # biteloncoind will not send blocktxn responses for blocks whose height is
